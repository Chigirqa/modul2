...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: process.env.EMAIL_USER || 'dimabrovko1982@gmail.com',       // поміняй на свої дані
    pass: process.env.EMAIL_PASS || 'updr shiq pipz vjvb',        // або використай змінні середовища
  },
});
